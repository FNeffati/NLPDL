...
def naiveSoftmaxLossAndGradient(
    ...
    # What is naive Softmax loss?
    # Given enter word c
    # What's the probability of outside word

    y_hat = softmax(np.dot(outsideVectors, centerWordVec))  # The predicted Distribution (probability distribution)
    y = np.zeros(y_hat.shape)

    y[outsideWordIdx] = 1  # The true empirical Distribution.
...
def skipgram(currentCenterWord, windowSize, outsideWords, word2Ind,
    ...
    for word in outsideWords:
        ...
        gradloss, gradCenterVec, gradOutsideVecs = word2vecLossAndGradient(centerWordVec, outsideWordIdx,
